...
const documents = [ collection, colorTheme, page, product, productVariant, post]
...
import htmlEmbed from './objects/module/htmlEmbed'
import imageSide from './objects/module/imageSide'
